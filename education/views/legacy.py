...
# --- extracted modules (phase 7) — keep legacy names available in this namespace ---
from .helpers import (  # noqa: E402
    _redirect_disabled_module,
    _ensure_center_ui_feature,
    get_active_center,
    _can_manage,
    _can_give_points,
    _director_or_manager,
    _teacher_can,
    _teacher_can_view_settings,
    _teacher_or_management_can_access_group,
)
