...
urlpatterns = [
    ...
    path('api/student/game/status/', api_views.student_game_status_api,      name='student_game_status_api'),
    path('api/student/game/result/', api_views.student_game_result_api,      name='student_game_result_api'),
    path('api/student/game/convert-balls/', api_views.game_convert_balls_api, name='game_convert_balls_api'),
    path('api/games/balls-config/', api_views.game_balls_config_api, name='game_balls_config_api'),
    # Parent panel APIs
    ...
    # Game management
    path('games/', views.game_hub_view, name='game_hub'),
    path('games/reyting/', views.game_rating_view, name='game_rating'),
    path('games/settings/', views.game_settings_view, name='game_settings'),
    path('games/super-admin/', views.game_super_admin_view, name='game_super_admin'),
    path('games/questions/', views.game_questions_view, name='game_questions'),
    path('games/<str:game_slug>/', views.game_play_view, name='game_play'),
    path('api/games/config/', api_views.game_config_api, name='game_config_api'),
    path('api/games/global-config/', api_views.global_game_config_api, name='global_game_config_api'),
    path('api/games/suggestion/', api_views.game_suggestion_api, name='game_suggestion_api'),
    path('api/games/suggestions/<int:pk>/review/', api_views.game_suggestion_review_api, name='game_suggestion_review_api'),
    path('api/games/<str:game_slug>/questions/', api_views.game_student_questions_api, name='game_student_questions_api'),
    path('api/games/<str:game_slug>/questions/manage/', api_views.game_questions_manage_api, name='game_questions_manage_api'),
    path('api/games/<str:game_slug>/questions/ai-generate/', api_views.game_questions_ai_generate, name='game_questions_ai_generate'),
    # ✅ Group permissions
