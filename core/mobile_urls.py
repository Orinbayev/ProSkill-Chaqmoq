...
urlpatterns = [
    ...
    path("auth/logout-all/", mobile_api.mobile_auth_logout_all, name="mobile_auth_logout_all"),
    path("auth/refresh/", mobile_api.mobile_auth_refresh, name="mobile_auth_refresh"),
    path("auth/sessions/", mobile_api.mobile_auth_sessions, name="mobile_auth_sessions"),
    path(
        "auth/sessions/<int:token_id>/revoke/",
        mobile_api.mobile_auth_session_revoke,
        name="mobile_auth_session_revoke",
    ),
