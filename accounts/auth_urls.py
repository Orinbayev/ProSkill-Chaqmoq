...
urlpatterns = [
    ...
    path('bot-centers/', api_auth.get_bot_centers, name='bot_centers'),
    path('bot-center-toggle/', api_auth.toggle_bot_center, name='bot_center_toggle'),
    path('bot-center-detail/', api_auth.get_bot_center_detail, name='bot_center_detail'),
    path('bot-finance/', api_auth.get_bot_finance, name='bot_finance'),
